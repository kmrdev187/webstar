...
export class FightComponent {
    ...
    game() {
        ...
        const attack = () => {
            ...
            setTimeout(() => {
                ...
                if(this.lightCharacter.health == 0 || this.darkCharacter.health == 0) {
                    this.checkWinner()
                } else {
                    attack()
                }
    ...
    checkWinner() {
        ...
        if(this.lightCharacter.health == 0) {
            document.querySelector('.fight-page__wrapper')?.classList.add('fight-page__wrapper--has-dark-winner')
        } else {
            document.querySelector('.fight-page__wrapper')?.classList.add('fight-page__wrapper--has-light-winner')
        }
    }
    ...
    ngOnInit() {
        ...
        this.lightCharacter.name = normalizeName(this.route.snapshot.queryParams['lname'])
        this.darkCharacter.name = normalizeName(this.route.snapshot.queryParams['dname'])
